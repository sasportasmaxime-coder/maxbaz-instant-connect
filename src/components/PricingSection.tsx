...
const PricingSection = () => {
  ...
  return (
    <section id="tarifs" className="relative py-24 px-4 overflow-hidden">
      {/* Background */}
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-20 animate-fade-up">
          <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full mb-6">
            <span className="text-accent font-semibold text-sm">Tarifs</span>
          </div>
          ...
          {plans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Card */}
                <div className={`relative bg-card rounded-3xl p-8 lg:p-10 shadow-xl hover-lift transition-smooth border ${
                  plan.featured ? 'border-accent/50 shadow-glow' : 'border-border/50'
                }`}>
                  {/* Gradient overlay */}
                  {plan.featured && (
                  ...
                  <div className="relative z-10">
                    ...
                    <Button
                      ...
                      className={`w-full text-base py-6 shadow-lg hover-glow transition-smooth ${
                        plan.featured ? 'bg-gradient-to-r from-primary to-accent hover:shadow-xl' : ''
                      }`}
                      size="lg"
                    >
