...
const FeaturesSection = () => {
  const features = [{
    ...
    description: "Un SMS est envoyé immédiatement après chaque appel manqué pour engager le prospect instantanément.",
    gradient: "from-blue-500 to-cyan-500"
  }, {
    icon: CheckCircle,
    title: "Qualification du besoin et Prise de rendez-vous instantanée",
    description: "Qualification automatique du besoin client et proposition immédiate de créneaux disponibles pour un rendez-vous.",
    gradient: "from-purple-500 to-pink-500"
  }, {
    icon: Calendar,
    title: "Fenêtre de réservation synchronisée",
    description: "Synchronisation automatique avec votre agenda numérique (Google Calendar, Outlook) pour éviter les doublons.",
    gradient: "from-green-500 to-emerald-500"
  }, {
    icon: BarChart3,
    title: "Tableau de bord interactif",
    description: "Suivez vos KPIs en temps réel : taux de conversion, nombre de rendez-vous, clients qualifiés et performances.",
    gradient: "from-orange-500 to-red-500"
  }];
  return <section id="fonctionnalites" className="relative py-24 px-4 overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-20 animate-fade-up">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto my-2">MaxBaz automatise la prise de rendez-vous pour les artisans et professionnels. Elle transforme chaque appel manqué en opportunité grâce à notre technologie qui qualifie et confirme le créneau choisi automatiquement.</p>
        </div>

        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => {
          const Icon = feature.icon;
          return <div key={index} className="group relative overflow-hidden" style={{
